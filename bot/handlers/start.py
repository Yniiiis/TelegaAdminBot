...
WELCOME_TEXT = (
    "Добро пожаловать в наш музыкальный сервис.\n\n"
    "Здесь вы слушаете музыку без цензуры: полные версии треков, без вырезанных куплетов "
    "и искусственных ограничений — каталог и рекомендации подстраиваются под ваш вкус."
)

SUBSCRIBE_PROMPT = (
    "Чтобы получить доступ, подпишитесь на наш Telegram-канал — там анонсы, подборки "
    "и обновления каталога."
)
